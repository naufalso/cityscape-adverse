...
trained_models=("original" "spring" "autumn" "snow" "rainy" "night" "foggy" "dawn" "sunny")
eval_datasets=("original" "spring" "autumn" "snow" "rainy" "night" "foggy" "dawn" "sunny")
...
do
    ...
    do
        ...
        --cfg-options visualizer.vis_backends.1.init_kwargs.tags=[segformer,transformer,mit-b0,${trained_model},cross-evaluation,eval_${eval_dataset},evaluation]
