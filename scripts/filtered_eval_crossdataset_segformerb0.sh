#!/bin/bash
cross_evaluation_dir=work_dirs/cross_evaluation_segformer

# Define the datasets array
trained_models=("spring" "autumn" "snow" "rainy" "night" "foggy" "dawn" "sunny" "all")
...
do
    ...
    do
        ...
        model_name=segformer_mit-b0_${trained_model}

        # Get the train model config path
        model_path=${cross_evaluation_dir}/${model_name}/segformer_mit-b0_original.py # ${model_name}.py
        ...
        --work-dir work_dirs/filtered_cross_evaluation_eval/segformer_mit-b0/segformer_mit-b0_${trained_model}_${eval_dataset} \
        ...
        --cfg-options visualizer.vis_backends.1.init_kwargs.name=filtered_eval_${model_name}_${eval_dataset} \
        --cfg-options visualizer.vis_backends.1.init_kwargs.tags=[segformer,transformer,mit-b0,${trained_model},cross-evaluation,filtered_eval_${eval_dataset},evaluation]
