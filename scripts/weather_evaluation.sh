...
for dataset in snow # spring foggy autumn snow sunny dawn night rainy
do
    ...
    do
        ...
        # Evaluate the model
        CUDA_VISIBLE_DEVICES=0 python tools/test.py $model $checkpoint --work-dir work_dirs/weather_reval/${dataset}/$model_name \
